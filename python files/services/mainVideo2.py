...
collection = MongoClient("mongodb+srv://rishita:2TtBYrnVNF81SHsg@cluster0.3qp3czu.mongodb.net/?retryWrites=true&w=majority")['pixel']['videos']

cloudinary.config(
    cloud_name="AGRISOOCHNA",
    api_key="236994191747786",
    api_secret="MCzndNWkInWyd1JVdU-A_jNcPWY"
)
